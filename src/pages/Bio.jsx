...
const Bio = () => {
  return (
    <>
      ...
      <section className="mt-3 col-lg-12">
        Short Bio
        <div className="box-info p-2">
          <p>
            I was born in Denmark on the 1st of August 2001 in [insert
            hospital/location]. My memory has always been hazy regarding my
            early years. At the age of [N/A], I relocated to Spain with my two
            older sisters to stay with our grandmother while our parents
            prepared to move from Denmark. Our grandma resided in a trailer
            park-style community, where we had the chance to meet diverse people
            and enjoy some excitement while waiting for our parents to join us
            in Spain. Once they arrived, we went through several relocations
            until we settled in Mijas Pueblo on the outskirts.
            <br />
            <br />
            ...
            [date] for an operation to receive a new kidney from my mother.
            After my recovery, I attended a boarding school in Grenaa, where I
            attempted pre-IB and IB programs. Regrettably, I did not make it
            into the IB program due to high absence and poor grades caused by
            medication side effects and stress from a weakened immune system
            from kidney treatment during covid. <br />
